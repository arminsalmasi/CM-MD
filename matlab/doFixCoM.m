%% functin doFixCoM - corrects center of mass to prevent drift
...
% Reduce the velocity to correct the center of mass
...
function [timeSpaceVec] = doFixCoM(timeSpaceVec)
  ...
  %% Loop over all atoms and correct the center of mass
    for i= 1 : timeSpaceVec.N                   %    
