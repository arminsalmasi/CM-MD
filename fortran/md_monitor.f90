...
!###############################################################################################
  ...
  ! Security: Validate physical parameters to prevent DoS and memory corruption
  IF (Temp < 0D0) STOP 'Error: Invalid physical parameter'
  IF (nCo < 0 .OR. nNi < 0 .OR. (nCo + nNi) <= 0) STOP 'Error: Invalid physical parameter'
  IF (V <= 0D0) STOP 'Error: Invalid physical parameter'
  IF (dt <= 0D0) STOP 'Error: Invalid physical parameter'
