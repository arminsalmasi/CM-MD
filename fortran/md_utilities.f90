...
!##########################################################
!##########################################################
SUBROUTINE do_rand_xyz(xyz, V, seed_val)
!##########################################################
...
!##########################################################
     ...
     REAL(dp)  :: r(3)     & ! random number
                , xyz(:,:) & ! position n*3
                , V          ! volume
     INTEGER, OPTIONAL :: seed_val

     np = SIZE(xyz,1)
     DO ix = 1, np
       IF (PRESENT(seed_val)) THEN
         CALL do_genRand(r, 3, ix, seed_val=seed_val+ix)
       ELSE
...
!##########################################################
!##########################################################
SUBROUTINE do_genRand(r,m,j,seed_val)
!##########################################################
