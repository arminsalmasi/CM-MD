%% functin doFixCoM - constrains center of mass to prevent drift
...
% Reduce the velocity to constrain the center of mass
...
function [timeSpaceVec] = doFixCoM(timeSpaceVec)
  ...
  %% Correct any center-of-mass drift V= V - VCoM
  %% Loop over all atoms and constrain the center of mass
    for i= 1 : timeSpaceVec.N                   %
